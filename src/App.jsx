...
function Advice({ adviceGen, adviceData, count }) {
  return (
    <div className="h-screen bg-dark-blue flex flex-col gap-4 items-center justify-center relative px-4">
      <div className="bg-dark-grayish-blue max-w-[370px] text-white p-10 rounded-lg text-center flex flex-col gap-4 min-h-[360px]">
        <p className="text-neon-green uppercase tracking-wide">
          A d v i c e #{count}
        </p>
        <p className="text-2xl font-semibold min-h-[160px]">
          {count === 0
      ...
      <div className="bg-green-400 rounded-full p-2 absolute bottom-28">
